...
BROKER_URL = 'amqp://guest:khb13719208594@localhost:5672/rabbitmqvhost'#消息代理
...
CELERY_RESULT_BACKEND='djcelery.backends.database:DatabaseBackend'#数据库作为保存celery数据后端
